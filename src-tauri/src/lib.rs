...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_build,
            commands::get_build_logs,
            commands::delete_build,
            commands::get_build_stats,
            commands::build_from_url,
            commands::compare_builds,
            commands::list_build_targets,
            commands::start_build_target,
            ...
            commands::docker_desktop_status,
            commands::switch_to_orca_runtime,
            commands::stop_docker_desktop,
            commands::list_templates,
            commands::refresh_templates,
            commands::deploy_template,
            commands::deploy_template_to_hosts,
